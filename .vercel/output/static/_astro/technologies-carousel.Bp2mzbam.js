import {
  ...
  b as n,
  c as x,
} from "./carousel.DQbr5KG0.js";
import { r as h } from "./index.NEDEFKed.js";
const p = (c) =>
    s.jsx("svg", {
  ...
  m = (c) =>
    s.jsxs("svg", {
      ...
      className: c.className,
      children: [
        s.jsx("path", { fill: "#f0db4f", d: "M0 0h1052v1052H0z" }),
        s.jsx("path", {
    ...
    s.jsxs("svg", {
      ...
      children: [
        s.jsxs("defs", {
          children: [
            s.jsxs("linearGradient", {
              ...
              y2: "89.755%",
              children: [
                s.jsx("stop", { offset: "0%", stopColor: "#41873F" }),
                s.jsx("stop", { offset: "32.88%", stopColor: "#418B3D" }),
                s.jsx("stop", { offset: "63.52%", stopColor: "#419637" }),
                s.jsx("stop", { offset: "93.19%", stopColor: "#3FA92D" }),
                s.jsx("stop", { offset: "100%", stopColor: "#3FAE2A" }),
              ],
            }),
            s.jsxs("linearGradient", {
              id: "c",
              ...
              y2: "-18.306%",
              children: [
                s.jsx("stop", { offset: "13.76%", stopColor: "#41873F" }),
                s.jsx("stop", { offset: "40.32%", stopColor: "#54A044" }),
                s.jsx("stop", { offset: "71.36%", stopColor: "#66B848" }),
                s.jsx("stop", { offset: "90.81%", stopColor: "#6CC04A" }),
              ],
            }),
            s.jsxs("linearGradient", {
              id: "f",
              ...
              y2: "49.997%",
              children: [
                s.jsx("stop", { offset: "9.192%", stopColor: "#6CC04A" }),
                s.jsx("stop", { offset: "28.64%", stopColor: "#66B848" }),
                s.jsx("stop", { offset: "59.68%", stopColor: "#54A044" }),
                s.jsx("stop", { offset: "86.24%", stopColor: "#41873F" }),
              ],
            }),
            s.jsx("path", {
              id: "b",
        ...
        s.jsx("mask", {
          id: "d",
          fill: "#fff",
          children: s.jsx("use", { xlinkHref: "#b" }),
        }),
        s.jsx("path", {
          fill: "url(#c)",
        ...
        s.jsx("mask", {
          id: "g",
          fill: "#fff",
          children: s.jsx("use", { xlinkHref: "#e" }),
        }),
        s.jsx("path", {
          fill: "url(#f)",
      ...
      children: [
        s.jsx("defs", {
          children: s.jsxs("linearGradient", {
            ...
            id: "gradient",
            children: [
              s.jsx("stop", { stopColor: "#2298BD", offset: "0%" }),
              s.jsx("stop", { stopColor: "#0ED7B5", offset: "100%" }),
            ],
          }),
        }),
        s.jsx("path", {
    ...
    () =>
      i(
        [
          ...
          { name: "React", icon: v },
          { name: "Svelte", icon: Z },
          { name: "Typescript", icon: f },
          { name: "Javascript", icon: m },
          { name: "TailwindCSS", icon: g },
          { name: "Docker", icon: p },
          { name: "Git", icon: d },
          { name: "Next.js", icon: C },
          { name: "Postgresql", icon: u },
          { name: "Mongodb", icon: j },
          { name: "Mysql", icon: M },
        ],
        8,
...
export { k as TechnologiesCarousel };
